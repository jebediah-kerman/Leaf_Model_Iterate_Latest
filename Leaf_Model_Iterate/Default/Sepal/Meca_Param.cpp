...
/////////////////////////Growth factor related
 int prefaCurve = 1;	// Which response curve should be used? 1 for tanh, 2 for linear, 3 for step, 4 for hill (default)
 ...
 real RelEl= 9; 		// The ratio beween elasticity for very low and very high density 1 < RelEl
 real RelElFactor = sqrt(RelEl);
