...
tmp=Densityxyh[]; Densityxyh=0; Densityxyh[]=tmp;
tmp=DensityInhxyh[]; DensityInhxyh=0; DensityInhxyh[]=tmp;
...
Elastxyh=Elastxyh;
Densityxyh=Densityxyh;
DensityInhxyh=DensityInhxyh;
