...
/////////////////////////Growth factor related
 ...
 // real Rhz = .02; 		// The density for the transition from high to low density regime.
 ...
 real RhzInh = 8; 		// The density for the transition from high to low density regime.
