...
/////////////////////////Growth factor related
 ...
 //real RhzInh = .03; 		// The density for the transition from high to low density regime.
 //real dRhoInh = 3.; 		// sensitivity of the elasticity with respect to the density at the transition from low to high density regime.
 if(prefbCurve == 4){
