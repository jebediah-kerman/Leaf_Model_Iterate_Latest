...
func real prefa(real Dens, real DifRelEl, real Rhz, real dRho){
	// sigmoidal impact from high to low density
	real Prefa = 1+DifRelEl*(1-tanh((Dens-Rhz)/dRho));
	// real Prefa = 1+DifRelEl*(1-tanh((Dens)/dRho));
	// real Prefa = 1;
	// if (Dens >= Rhz){
